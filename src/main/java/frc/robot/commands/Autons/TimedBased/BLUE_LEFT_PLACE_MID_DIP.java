...
public class BLUE_LEFT_PLACE_MID_DIP extends SequentialCommandGroup {
  /** Creates a new BLUE_LEFT_PLACE_MID_DIP. */
  public BLUE_LEFT_PLACE_MID_DIP(SwerveSubsystem SwerveDrive, extenderSubsystem extender, ArmSubsystem arm, WristSubsystem wrist,
  ClawSubsystem claw) {
