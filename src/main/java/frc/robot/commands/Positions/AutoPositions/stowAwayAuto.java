...
public class stowAwayAuto extends SequentialCommandGroup {
  /** Creates a new stowAwayAuto. */
  public stowAwayAuto(extenderSubsystem extender, ArmSubsystem arm, WristSubsystem wristSubsystem) {
