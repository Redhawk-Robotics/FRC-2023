...
//     private final PDH powerDistributionHub = new PDH();
    ...
    private final Trigger driver_TopRightRearButton = new JoystickButton(DRIVER, XboxController.Button.kRightStick.value);
    ...
    private final Trigger opperator_BottomRightRearButton = new JoystickButton(OPERATOR, XboxController.Button.kStart.value);
    private final Trigger opperator_BottomLeftRearButton = new JoystickButton(OPERATOR, XboxController.Button.kBack.value);

    private final Trigger opperator_TopLeftRearButton = new JoystickButton(OPERATOR, XboxController.Button.kLeftStick.value);
    private final Trigger opperator_TopRightRearButton = new JoystickButton(OPERATOR, XboxController.Button.kRightStick.value);
    ...
    private void configureButtonBindings() {
        ...
        // arm High
        opperator_X.whileTrue(new SequentialCommandGroup(
                // PROTECTION
                ...
                arm.armEncoder() < 8 ? 
                        ...
                        : 
                        new ParallelCommandGroup(
                                new WristSetPoint(wrist, wrist.wristEncoder()), 
                                new ExtenderSetPoint(extender, 0)),
                new ArmSetPoint(arm, 44),
                new ParallelCommandGroup(
                        new ArmSetPoint(arm, 44),
                        new WristSetPoint(wrist, 0),
                        new ExtenderSetPoint(extender, -50))));
    ...
    public void configureAutons() {
        ...
        * is field-centric meaning when looking down, left is negative and right is postive.
        */
        ...
        //             new ArmSetPoint(arm, 43)),
        //     // REALSE CONE
        //     new ParallelCommandGroup(new ClawCMD(claw, false), new ArmSetPoint(arm, 43)), 
        //     new WaitCommand(1),
        //     // STOWE AWAY
        //     new ParallelCommandGroup(new WristSetPoint(wrist, 0),
        //             new ExtenderSetPoint(extender, 0)),
        ...
        return new SequentialCommandGroup(
                arm.armEncoder() < 6 ? 
                        ...
                        new ParallelCommandGroup(
                                new WristSetPoint(wrist, wrist.wristEncoder()), 
                                new ExtenderSetPoint(extender, 0)),
                new ArmSetPoint(arm, 11),
                new InstantCommand(() -> claw.coneIntake()),
                new ParallelCommandGroup(
                        new ExtenderSetPoint(extender, 0),
                        new WristSetPoint(wrist, -20),
                        new ARMSTAY(arm, 11)));
    }
